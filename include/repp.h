...
namespace Repp
{
    ...
    struct CpuContext
    {
        ...
        {
            if (name == "rax") rax = value;
            else if (name == "rbx") rbx = value;
            else if (name == "rcx") rcx = value;
            else if (name == "rdx") rdx = value;
            else if (name == "rsi") rsi = value;
            else if (name == "rdi") rdi = value;
            else if (name == "rbp") rbp = value;
            else if (name == "rsp") rsp = value;
            else if (name == "r8") r8 = value;
            else if (name == "r9") r9 = value;
            else if (name == "r10") r10 = value;
            else if (name == "r11") r11 = value;
            else if (name == "r12") r12 = value;
            else if (name == "r13") r13 = value;
            else if (name == "r14") r14 = value;
            else if (name == "r15") r15 = value;
            else if (name == "rip") rip = value;
            else if (name == "rflags") rflags = value;
        }
    };
    ...
    struct CpuContext
    {
        ...
        {
            if (name == "eax") eax = value;
            else if (name == "ebx") ebx = value;
            else if (name == "ecx") ecx = value;
            else if (name == "edx") edx = value;
            else if (name == "esi") esi = value;
            else if (name == "edi") edi = value;
            else if (name == "ebp") ebp = value;
            else if (name == "esp") esp = value;
            else if (name == "eip") eip = value;
            else if (name == "eflags") eflags = value;
        }
    };
    ...
    struct CpuContext
    {
        ...
        uint64_t getReg(const std::string& name) const
        {
            if (name.substr(0, 1) == "x" && name.length() <= 3)
            {
                ...
                if (regNum >= 0 && regNum <= 30) return x[regNum];
            }
            if (name == "sp") return sp;
            if (name == "pc") return pc;
            if (name == "pstate") return pstate;
            return 0;
        }
        ...
        void setReg(const std::string& name, uint64_t value)
        {
            ...
            {
                int regNum = std::stoi(name.substr(1));
                if (regNum >= 0 && regNum <= 30) x[regNum] = value;
            }
            else if (name == "sp") sp = value;
            else if (name == "pc") pc = value;
            else if (name == "pstate") pstate = value;
        }
    };
    ...
    struct CpuContext
    {
        ...
        uint32_t getReg(const std::string& name) const
        {
            ...
            {
                int regNum = std::stoi(name.substr(1));
                if (regNum >= 0 && regNum <= 12) return r[regNum];
            }
            if (name == "sp") return sp;
            if (name == "lr") return lr;
            if (name == "pc") return pc;
        ...
        void setReg(const std::string& name, uint32_t value)
        {
            ...
            {
                int regNum = std::stoi(name.substr(1));
                if (regNum >= 0 && regNum <= 12) r[regNum] = value;
            }
            else if (name == "sp") sp = value;
            else if (name == "lr") lr = value;
            else if (name == "pc") pc = value;
            else if (name == "cpsr") cpsr = value;
        }
    };
#endif
    ...
    static std::vector<MemoryRegion> enumerateMemoryRegions()
    {
        ...
        while (fgets(line, sizeof(line), fp))
        {
            ...
            if (sscanf(line, "%lx-%lx %4s", &start, &end, perms) == 3)
            {
                ...
                region.protection = 0;
                if (region.readable) region.protection |= PROT_READ;
                if (region.writable) region.protection |= PROT_WRITE;
                if (region.executable) region.protection |= PROT_EXEC;
    ...
    static uintptr_t getArgument(int index)
    {
        ...
        switch (index)
        {
            case 0: return getRegister<uintptr_t>("rdi");
            case 1: return getRegister<uintptr_t>("rsi");
            case 2: return getRegister<uintptr_t>("rdx");
            case 3: return getRegister<uintptr_t>("rcx");
            case 4: return getRegister<uintptr_t>("r8");
            case 5: return getRegister<uintptr_t>("r9");
            default:
            {
    ...
    static void setArgument(int index, uintptr_t value)
    {
        ...
        switch (index)
        {
            case 0: setRegister("rdi", value); break;
            case 1: setRegister("rsi", value); break;
            case 2: setRegister("rdx", value); break;
            case 3: setRegister("rcx", value); break;
            case 4: setRegister("r8", value); break;
            case 5: setRegister("r9", value); break;
            default:
            {
                uintptr_t rsp = getRegister<uintptr_t>("rsp");
